...
public class SandwichWizardModel extends AbstractWizardModel {
    ...
    protected PageList onNewRootPageList() {
        return new PageList(new BranchPage(this, "选择自助种类")
...
//                        new TextPage(this, "How Many Salads?").setRequired(true)).setRequired(true),

                      new NumberPage(this, "How Many Salads?").setRequired(true)).setRequired(true),


                new TextPage(this, "备注").setRequired(true).setRequired(true),

                new CustomerInfoPage(this, "有什么需要请留言").setRequired(true));
    }
}
